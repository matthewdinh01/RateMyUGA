...
// // Define the structure of a ranking
// interface Ranking {
//   _id: string;
//   email: string;
//   location: string;
...
//     alert(`Editing ranking with ID: ${id}`);
//     // Logic to navigate to or display an edit form can be implemented here.
//   };
...
//                   .filter(([key]) => !["_id", "email", "location", "comments", "__v"].includes(key))
//                   .map(([key, value]) => (
//                     <li key={key}>
...
//                   onClick={() => handleEdit(ranking._id)}
//                 >
//                   Edit
//                 </button>
//                 <button
