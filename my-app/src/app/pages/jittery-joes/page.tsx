...
async function getData(): Promise<Location> {
  try {
    ...
    return {
      name: "Jittery Joe's",
      address: "48 Baxter St. Athens, GA 30602 || 215 D.W. Brooks Dr. Athens, GA 30602 || 225 Herty Dr. Athens, GA 30602",
      image: "/jittery.webp",
      extraInfo: {
        Printer: false,
        "Rest Area": true,
